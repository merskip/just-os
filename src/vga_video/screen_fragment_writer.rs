...
fn test_write_short_text() {
    ...
    let frame_buffer_cell = RefCell::new(MockFrameBuffer::new(80, 25));
    ...
    let frame_buffer = frame_buffer_cell.borrow();
...
fn test_write_multiline_text() {
    ...
    let frame_buffer = RefCell::new(MockFrameBuffer::new(80, 25));
    let mut writer = ScreenFragmentWriter::new(
        Rect::new(Point::new(1, 1), Size::new(10, 3)),
        CharacterColor::default(),
        &frame_buffer,
